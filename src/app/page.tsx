...
export default function page() {
  return (
    <div className="lg:mx-[8rem] lg:my-[2rem] m-4 ">
      <main>
        <Navbar />
        <div className="flex flex-col md:flex-row sm:flex-row justify-between gap-4 mt-4 h-[16rem]">
          <div className="h-full lg:w-1/3 md:w-full  gap-2 flex flex-col justify-between shadow-sm bg-gray-950">
            <Temperature />
          </div>
          ...
          <div className="h-full lg:w-1/3 md:w-full flex flex-col justify-between gap-2">
            <div className="h-1/2 w-full flex  gap-2">
              <div className="w-1/2 h-full  p-0.5 rounded-lg shadow-sm bg-gray-950">
                <Sunset />
              </div>
              <div className="w-1/2 h-full  p-0.5 rounded-lg shadow-sm bg-gray-950">
                <Wind />
